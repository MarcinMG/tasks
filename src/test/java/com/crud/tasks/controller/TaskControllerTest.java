...
public class TaskControllerTest {
    ...
    public void shouldGetTask() throws Exception {
        ...
        //When && Then
        mockMvc.perform(get("/v1/tasks/{taskId}", 11L).contentType(MediaType.APPLICATION_JSON)
                .param("taskId", "11"))
                .andExpect(status().isOk())
    ...
    public void shouldDeleteTask() throws Exception {
        //Given
        //When && Then
        mockMvc.perform(delete("/v1/tasks/{taskId}", 12L).contentType(MediaType.APPLICATION_JSON)
                .param("taskId", "12"))
                .andExpect(status().isOk());
    }
