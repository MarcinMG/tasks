...
public class TrelloClientTest {
    ...
    public void init() {
       ...
       // when(trelloConfig.getTrelloUsername()).thenReturn("marcinmodrakgrabowski");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException{
       ...
       // when(trelloConfig.getTrelloUsername()).thenReturn("trello username");

       // URI uri = new URI("http://test.com/members/macinmodrakgrabowski/boards?key=test&token=test&fields=name,id&lists=all");
